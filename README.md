...
```
# Output Waveform
![image](https://github.com/user-attachments/assets/52e03dfc-c180-44a1-b5a6-98b0ec86ba29)

# Results
Thus, A Python program is successfully executed for the Construction and Reconctruction of Flat-Top Sampleing.

# Hardware experiment output waveform.
![WhatsApp Image 2025-05-10 at 15 44 38_116cb12f](https://github.com/user-attachments/assets/e67702b9-4711-4a8e-a7ce-e57958546eeb)
